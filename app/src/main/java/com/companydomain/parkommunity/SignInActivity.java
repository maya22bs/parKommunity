...
public class SignInActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener,
    ...
    private static final String TAG = "TAG_"+SignInActivity.class.getSimpleName();
   ...
   // private FirebaseAuth.AuthStateListener mAuthListener;
    ...
    private Class next; //next activity to go to
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCallbackManager = MainActivity.mCallbackManager;
     ...
     //   mFirebaseAuth = FirebaseAuth.getInstance();
        ...
        next = (Class)getIntent().getSerializableExtra(NEXT_CLASS_EXTRA);
        if (next == null) {
...
//                                initMyStaticVariables(getApplicationContext());
//                            }
//                            startActivity(new Intent(currentActivity, next));
                        }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            ...
                            startActivity(new Intent(SignInActivity.this, next));
                            finish();
                        }
                    }
                });
